...
!----------------------------------------------------------
 ...
 call register_restart_variable ( fileobj, 't_surf',         Ice%t_surf,         dim_names )
 call register_restart_variable ( fileobj, 'thickness',      Ice%thickness,      dim_names )
 call register_restart_variable ( fileobj, 'albedo',         Ice%albedo,         dim_names )
 call register_restart_variable ( fileobj, 'albedo_vis_dir', Ice%albedo_vis_dir, dim_names )
 call register_restart_variable ( fileobj, 'albedo_nir_dir', Ice%albedo_nir_dir, dim_names )
 call register_restart_variable ( fileobj, 'albedo_vis_dif', Ice%albedo_vis_dif, dim_names )
 call register_restart_variable ( fileobj, 'albedo_nir_dif', Ice%albedo_nir_dif, dim_names )
 call register_restart_variable ( fileobj, 'rough_mom',      Ice%rough_mom,      dim_names )
 call register_restart_variable ( fileobj, 'rough_heat',     Ice%rough_heat,     dim_names )
 call register_restart_variable ( fileobj, 'rough_moist',    Ice%rough_moist,    dim_names )
...
!######################################################################
 ...
 if( do_netcdf_restart) then
    ...
    if (open_file(ice_restart_fileobj, fname, 'ovewrite', Ice%domain, is_restart=.true.)) then
        call ice_register_restart(ice_restart_fileobj, Ice)
 ...
 subroutine ice_restart_fileobj(fileobj)
  ...
  integer :: is, ie !< Starting and Ending indices for data
    ...
    deallocate(buffer)
 end subroutine ice_restart_fileobj
